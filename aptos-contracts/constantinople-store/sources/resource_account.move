...
module aptos_constantinople_demo_store::resource_account {
    use aptos_framework::account;
    use std::bcs;
    use std::signer;
    use std::vector;

    friend aptos_constantinople_demo_store::genesis_account;
    ...
    public(friend) fun initialize(genisis_account: &signer) {
        ...
        vector::append(&mut seed, b"AptosConstantinopleDemo");
