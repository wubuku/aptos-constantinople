...
public class HibernateObstructionStateQueryRepository implements ObstructionStateQueryRepository {
    ...
    public ObstructionState get(Position id) {
        ...
        ObstructionState state = (ObstructionState)getCurrentSession().get(AbstractObstructionState.SimpleObstructionState.class, id);
    ...
    public Iterable<ObstructionState> getAll(Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(ObstructionState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<ObstructionState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(ObstructionState.class);
        criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
        HibernateUtils.criteriaAddFilterAndOrdersAndSetFirstResultAndMaxResults(criteria, filter, orders, firstResult, maxResults);
        addNotDeletedRestriction(criteria);
    ...
    @Transactional(readOnly = true)
    public ObstructionState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders) {
        List<ObstructionState> list = (List<ObstructionState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public ObstructionState getFirst(Map.Entry<String, Object> keyValue, List<String> orders) {
