package org.test.aptosconstantinopledemo.specialization.hibernate;
...
public class TableIdGenerator<TCommand, TState> implements IdGenerator<Long, TCommand, TState> {
    ...
    private static final String DEFAULT_ROOT_ENTITY_NAME = "org.test.aptosconstantinopledemo.tool.hibernate.Hello";
