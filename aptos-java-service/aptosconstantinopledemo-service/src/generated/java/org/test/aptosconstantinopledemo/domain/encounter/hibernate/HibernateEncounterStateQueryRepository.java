...
public class HibernateEncounterStateQueryRepository implements EncounterStateQueryRepository {
    ...
    public EncounterState get(String id) {
        ...
        EncounterState state = (EncounterState)getCurrentSession().get(AbstractEncounterState.SimpleEncounterState.class, id);
    ...
    public Iterable<EncounterState> getAll(Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(EncounterState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<EncounterState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(EncounterState.class);
        criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
        HibernateUtils.criteriaAddFilterAndOrdersAndSetFirstResultAndMaxResults(criteria, filter, orders, firstResult, maxResults);
        addNotDeletedRestriction(criteria);
    ...
    @Transactional(readOnly = true)
    public EncounterState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders) {
        List<EncounterState> list = (List<EncounterState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public EncounterState getFirst(Map.Entry<String, Object> keyValue, List<String> orders) {
