...
public class HibernateMapStateQueryRepository implements MapStateQueryRepository {
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("AccountAddress", "Width", "Height", "Terrain", "OffChainVersion", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted", "Version"));
    ...
    public MapState get(String id) {
        ...
        if (getReadOnlyProxyGenerator() != null && state != null) {
            return (MapState) getReadOnlyProxyGenerator().createProxy(state, new Class[]{MapState.SqlMapState.class}, "getStateReadOnly", readOnlyPropertyPascalCaseNames);
        }
        return state;
    }
