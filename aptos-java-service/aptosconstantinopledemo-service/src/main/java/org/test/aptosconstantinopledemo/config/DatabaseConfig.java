...
import org.test.aptosconstantinopledemo.specialization.NullReadOnlyProxyGenerator;
...
//    }
    ...
    public LocalSessionFactoryBean hibernateSessionFactory() throws IOException {
        ...
        sessionFactory.setPackagesToScan("org.test.aptosconstantinopledemo.*"); //add annotation mappings
