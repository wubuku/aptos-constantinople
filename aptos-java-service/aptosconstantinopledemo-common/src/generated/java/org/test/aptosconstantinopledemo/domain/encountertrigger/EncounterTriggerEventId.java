...
import org.test.aptosconstantinopledemo.domain.Position;
import java.math.BigInteger;
import org.test.aptosconstantinopledemo.domain.*;

public class EncounterTriggerEventId implements Serializable {
    ...
    protected BigInteger getPositionX()
    {
        return getPosition().getX();
    }

    protected void setPositionX(BigInteger positionX)
    {
        getPosition().setX(positionX);
    }

    protected BigInteger getPositionY()
    {
        return getPosition().getY();
    }

    protected void setPositionY(BigInteger positionY)
    {
        getPosition().setY(positionY);
    }

    public EncounterTriggerEventId()
    {
    }

    public EncounterTriggerEventId(Position position, BigInteger version)
    {
        this.position = position;
        this.version = version;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        EncounterTriggerEventId other = (EncounterTriggerEventId)obj;
        return true 
            && (position == other.position || (position != null && position.equals(other.position)))
    ...
    public int hashCode()
    {
        ...
        if (this.position != null) {
            hash += 13 * this.position.hashCode();
        }
    ...
    public String toString() {
        return "EncounterTriggerEventId{" +
                "position=" + position +
                ", version=" + version +
                '}';
    }
