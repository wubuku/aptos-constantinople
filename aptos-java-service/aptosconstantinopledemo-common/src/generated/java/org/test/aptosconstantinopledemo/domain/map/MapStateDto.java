...
public class MapStateDto {
    ...
    public static class DtoConverter extends AbstractStateDtoConverter
    {
        ...
        public MapStateDto toMapStateDto(MapState state)
        {
            ...
            if (returnedFieldsContains("Width")) {
                dto.setWidth(state.getWidth());
            }
            if (returnedFieldsContains("Height")) {
                dto.setHeight(state.getHeight());
            }
            ...
            if (returnedFieldsContains("Terrain")) {
                ArrayList<String> arrayList = new ArrayList();
                if (state.getTerrain() != null) {
                    for (String s : state.getTerrain()) {
                        arrayList.add(s);
                    }
                }
                dto.setTerrain(arrayList.toArray(new String[0]));
            }
            return dto;
        }
