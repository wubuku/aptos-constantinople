...
public abstract class AbstractMovableEvent extends AbstractEvent implements MovableEvent.SqlMovableEvent, AptosEvent.MutableAptosEvent, HasStatus.MutableHasStatus {
    private MovableEventId movableEventId = new MovableEventId();

    public MovableEventId getMovableEventId() {
        return this.movableEventId;
    }

    public void setMovableEventId(MovableEventId eventId) {
        this.movableEventId = eventId;
    }
    
    public String getPlayerId() {
        return getMovableEventId().getPlayerId();
    }

    public void setPlayerId(String playerId) {
        getMovableEventId().setPlayerId(playerId);
    }
    ...
    public BigInteger getVersion() {
        return getMovableEventId().getVersion();
    }
    
    public void setVersion(BigInteger version) {
        getMovableEventId().setVersion(version);
    }
    ...
    protected AbstractMovableEvent() {
    }

    protected AbstractMovableEvent(MovableEventId eventId) {
        this.movableEventId = eventId;
    }
