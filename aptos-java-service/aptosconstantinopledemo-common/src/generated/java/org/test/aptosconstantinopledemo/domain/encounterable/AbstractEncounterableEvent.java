...
public abstract class AbstractEncounterableEvent extends AbstractEvent implements EncounterableEvent.SqlEncounterableEvent, AptosEvent.MutableAptosEvent, HasStatus.MutableHasStatus {
    private EncounterableEventId encounterableEventId = new EncounterableEventId();

    public EncounterableEventId getEncounterableEventId() {
        return this.encounterableEventId;
    }

    public void setEncounterableEventId(EncounterableEventId eventId) {
        this.encounterableEventId = eventId;
    }
    
    public String getPlayerId() {
        return getEncounterableEventId().getPlayerId();
    }

    public void setPlayerId(String playerId) {
        getEncounterableEventId().setPlayerId(playerId);
    }
    ...
    public BigInteger getVersion() {
        return getEncounterableEventId().getVersion();
    }
    
    public void setVersion(BigInteger version) {
        getEncounterableEventId().setVersion(version);
    }
    ...
    protected AbstractEncounterableEvent() {
    }

    protected AbstractEncounterableEvent(EncounterableEventId eventId) {
        this.encounterableEventId = eventId;
    }
    ...
    public static class EncounterableClobEvent extends AbstractEncounterableEvent {
        ...
        public String getEventClass() {
            return "EncounterableClobEvent";
        }

    }

    public static class EncounterableCreated extends EncounterableClobEvent implements EncounterableEvent.EncounterableCreated {
