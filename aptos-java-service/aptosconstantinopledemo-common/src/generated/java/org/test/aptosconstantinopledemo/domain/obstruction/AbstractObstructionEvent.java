...
public abstract class AbstractObstructionEvent extends AbstractEvent implements ObstructionEvent.SqlObstructionEvent, AptosEvent.MutableAptosEvent, HasStatus.MutableHasStatus {
    private ObstructionEventId obstructionEventId = new ObstructionEventId();

    public ObstructionEventId getObstructionEventId() {
        return this.obstructionEventId;
    }

    public void setObstructionEventId(ObstructionEventId eventId) {
        this.obstructionEventId = eventId;
    }
    
    public Position getPosition() {
        return getObstructionEventId().getPosition();
    }

    public void setPosition(Position position) {
        getObstructionEventId().setPosition(position);
    }
    ...
    public BigInteger getVersion() {
        return getObstructionEventId().getVersion();
    }
    
    public void setVersion(BigInteger version) {
        getObstructionEventId().setVersion(version);
    }
    ...
    protected AbstractObstructionEvent() {
    }

    protected AbstractObstructionEvent(ObstructionEventId eventId) {
        this.obstructionEventId = eventId;
    }
